...
## `lux-cli` - [0.25.3](https://github.com/cyeganeh01248/lux/compare/v0.25.2...v0.25.3) - 2026-02-18

### Dependencies
- *(deps)* bump termtree from 0.5.1 to 1.0.0 ([#1346](https://github.com/cyeganeh01248/lux/pull/1346))

## `lux-lib` - [0.32.3](https://github.com/cyeganeh01248/lux/compare/lux-lib-v0.32.2...lux-lib-v0.32.3) - 2026-02-18

### Dependencies
- *(deps)* bump zip from 8.0.0 to 8.1.0 ([#1351](https://github.com/cyeganeh01248/lux/pull/1351))
- *(deps)* bump zip from 7.4.0 to 8.0.0 ([#1350](https://github.com/cyeganeh01248/lux/pull/1350))
- *(deps)* bump bon from 3.8.1 to 3.9.0 ([#1347](https://github.com/cyeganeh01248/lux/pull/1347))
